//la classe snake si trova ora nel file snake.js
//modulo generale che gestisce il gioco --> sketch.js
//modulo che gestisce il serpente --> snake.js


//SNAKE
//classi e costruttori (oggetti)
let s;
let scl = 20;
...
function draw() {
  if (game_status === 'Playing') {
    ...
    //accedere ai parametri della classe
    s.show();
    s.update();  
...
function pickFoodLocation() {
  ...
  //posizioni random dove creeremo il cibo 
